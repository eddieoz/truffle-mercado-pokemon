...
module.exports = function(deployer) {
  ...
  deployer.deploy(PokeCentral, {gas:3548144}).then(function(){
    ...
    pokecentral.newPokemon(3,500,40, {from:web3.eth.accounts[0],gas:350000}).then(function(){
      return pokecentral.transferPokemon(web3.eth.accounts[0], account1Demo, 1,{from:web3.eth.accounts[0],gas:2000000});
    });

    pokecentral.newPokemon(1,535,70, {from:web3.eth.accounts[0],gas:350000}).then(function(){
      return pokecentral.transferPokemon(web3.eth.accounts[0], account2Demo, 2,{from:web3.eth.accounts[0],gas:2000000});
    });
